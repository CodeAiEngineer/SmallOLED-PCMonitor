...
<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Mini OLED Configurator v1.5.3</title><style> *{box-sizing:border-box}body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;margin:0;padding:20px;background:linear-gradient(135deg,#0f0c29 0%,#1a1a2e 50%,#24243e 100%);background-attachment:fixed;color:#e0e7ff;min-height:100vh}.container{max-width:420px;margin:0 auto;padding-bottom:100px}h1{color:#fff;text-align:center;font-size:28px;font-weight:700;margin:0 0 8px;text-shadow:0 2px 10px rgba(0,212,255,.3)}.card{background:rgba(22,33,62,.6);backdrop-filter:blur(10px);padding:20px;border-radius:12px;margin-bottom:15px;border:1px solid rgba(0,212,255,.15);box-shadow:0 4px 15px rgba(0,0,0,.2)}label{display:block;margin:15px 0 8px;color:#00d4ff;font-size:14px;font-weight:500;letter-spacing:.3px}select,input[type="number"],input[type="text"]{width:100%;padding:12px 14px;border:2px solid rgba(0,212,255,.2);border-radius:8px;background:rgba(15,52,96,.5);color:#fff;font-size:15px;transition:all .3s ease;cursor:pointer}select:hover,input[type="number"]:hover,input[type="text"]:hover{border-color:rgba(0,212,255,.4);background:rgba(15,52,96,.7)}select:focus,input:focus{outline:none;border-color:#00d4ff;background:rgba(15,52,96,.8);box-shadow:0 0 0 3px rgba(0,212,255,.1)}input[type="checkbox"]{appearance:none;width:20px;height:20px;border:2px solid rgba(0,212,255,.4);border-radius:5px;background:rgba(15,52,96,.5);cursor:pointer;position:relative;transition:all .3s ease;flex-shrink:0}input[type="checkbox"]:hover{border-color:#00d4ff;transform:scale(1.05)}input[type="checkbox"]:checked{background:linear-gradient(135deg,#00d4ff 0%,#0096ff 100%);border-color:#00d4ff}input[type="checkbox"]:checked::after{content:'✓';position:absolute;color:#0f0c29;font-size:14px;font-weight:bold;top:50%;left:50%;transform:translate(-50%,-50%)}button{width:100%;padding:14px;margin-top:20px;border:none;border-radius:8px;font-size:16px;font-weight:600;cursor:pointer;transition:all .3s ease;text-transform:uppercase;letter-spacing:.5px}.save-btn{background:linear-gradient(135deg,#00d4ff 0%,#0096ff 100%);color:#0f0c29;box-shadow:0 4px 15px rgba(0,212,255,.3)}.save-btn:hover{transform:translateY(-2px);box-shadow:0 6px 20px rgba(0,212,255,.4)}.save-btn:active{transform:translateY(0)}.reset-btn{background:linear-gradient(135deg,#ff6b6b 0%,#ee5a52 100%);color:#fff;box-shadow:0 4px 15px rgba(255,107,107,.2)}.reset-btn:hover{transform:translateY(-2px);box-shadow:0 6px 20px rgba(255,107,107,.3)}.reset-btn:active{transform:translateY(0)}.info{text-align:center;color:#94a3b8;font-size:12px;margin-top:20px}.status{background:rgba(15,52,96,.4);padding:12px;border-radius:10px;text-align:center;margin-bottom:20px;border:1px solid rgba(0,212,255,.2);font-size:14px}.section-header{background:linear-gradient(135deg,rgba(15,52,96,.6) 0%,rgba(26,77,122,.4) 100%);padding:16px 18px;border-radius:10px;cursor:pointer;margin-bottom:10px;user-select:none;display:flex;justify-content:space-between;align-items:center;border:1px solid rgba(0,212,255,.15);transition:all .3s ease}.section-header:hover{background:linear-gradient(135deg,rgba(15,52,96,.8) 0%,rgba(26,77,122,.6) 100%);transform:translateX(4px);border-color:rgba(0,212,255,.3)}.section-header h3{margin:0;color:#00d4ff;font-size:16px;font-weight:600}.section-arrow{font-size:14px;transition:transform .3s ease;color:#00d4ff}.section-arrow.collapsed{transform:rotate(-90deg)}.section-content{max-height:10000px;overflow:visible;transition:max-height .3s ease,opacity .3s ease;opacity:1}.section-content.collapsed{max-height:0;overflow:hidden;opacity:0}.config-buttons{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:20px}.export-btn{background:linear-gradient(135deg,#10b981 0%,#059669 100%);color:#fff;padding:12px;font-size:14px;margin-top:0;border-radius:8px;font-weight:600;box-shadow:0 4px 12px rgba(16,185,129,.2);transition:all .3s ease}.export-btn:hover{transform:translateY(-2px);box-shadow:0 6px 16px rgba(16,185,129,.3)}.import-btn{background:linear-gradient(135deg,#3b82f6 0%,#2563eb 100%);color:#fff;padding:12px;font-size:14px;margin-top:0;border-radius:8px;font-weight:600;box-shadow:0 4px 12px rgba(59,130,246,.2);transition:all .3s ease}.import-btn:hover{transform:translateY(-2px);box-shadow:0 6px 16px rgba(59,130,246,.3)}.sticky-save{position:fixed;bottom:0;left:0;right:0;background:linear-gradient(to top,rgba(15,12,41,.98) 0%,rgba(15,12,41,.95) 100%);backdrop-filter:blur(10px);padding:12px 20px;box-shadow:0 -4px 20px rgba(0,0,0,.4);z-index:1000;border-top:1px solid rgba(0,212,255,.2)}.sticky-save .container{max-width:420px;margin:0 auto}.sticky-save button{margin-top:0}#importFile{display:none}@media (max-width:480px){body{padding:12px}.container{padding-bottom:90px}h1{font-size:24px}.card{padding:16px}.section-header{padding:14px 16px}.section-header h3{font-size:15px}select,input[type="number"],input[type="text"]{font-size:16px;padding:11px 12px}button{padding:13px;font-size:15px}.sticky-save{padding:10px 12px}}@media (max-width:360px){h1{font-size:22px}.config-buttons{grid-template-columns:1fr;gap:8px}}</style></head><body><div class="container"><h1>&#128421; Mini OLED Configurator <span style="font-size: 0.5em; font-weight: normal;">v1.5.3 + Custom</span></h1><div class="status"><strong>IP:</strong> )rawliteral" + WiFi.localIP().toString() + R"rawliteral( | <strong>UDP Port:</strong> 4210
 ...
 Enable smoother 4-frame walking animation.</p></div><div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #3b82f6;"><h4 style="color: #10b981; margin-top: 0; font-size: 14px;">🍄 Idle Encounters (v1.5.2)</h4><div style="margin-top: 10px;"><label style="display: flex; align-items: center; cursor: pointer;"><input type="checkbox" name="marioIdleEncounters" id="marioIdleEncounters"
 )rawliteral" + String(settings.marioIdleEncountersEnabled ? "checked" : "") + R"rawliteral(
 style="margin-right: 10px; width: 18px; height: 18px;"><span>Enable Idle Encounters</span></label><p style="color: #888; font-size: 11px;">
 Between minute changes, Mario encounters enemies during idle time.</p></div><label for="marioEncounterFrequency" style="margin-top: 10px;">Encounter Frequency</label><select name="marioEncounterFrequency" id="marioEncounterFrequency"><option value="0" )rawliteral" + String(settings.marioEncounterFrequency == 0 ? "selected" : "") + R"rawliteral(>Rare (25-35s)</option><option value="1" )rawliteral" + String(settings.marioEncounterFrequency == 1 ? "selected" : "") + R"rawliteral(>Normal (15-25s)</option><option value="2" )rawliteral" + String(settings.marioEncounterFrequency == 2 ? "selected" : "") + R"rawliteral(>Frequent (8-15s)</option><option value="3" )rawliteral" + String(settings.marioEncounterFrequency == 3 ? "selected" : "") + R"rawliteral(>Chaotic (2-5s)</option></select><label for="marioEncounterSpeed" style="margin-top: 10px;">Encounter Speed</label><select name="marioEncounterSpeed" id="marioEncounterSpeed"><option value="0" )rawliteral" + String(settings.marioEncounterSpeed == 0 ? "selected" : "") + R"rawliteral(>Slow</option><option value="1" )rawliteral" + String(settings.marioEncounterSpeed == 1 ? "selected" : "") + R"rawliteral(>Normal</option><option value="2" )rawliteral" + String(settings.marioEncounterSpeed == 2 ? "selected" : "") + R"rawliteral(>Fast</option></select></div></div><!-- Arkanoid Clock Settings (only visible when Arkanoid is selected) --><div id="pongSettings" style="display: )rawliteral" + String(settings.clockStyle == 5 ? "block" : "none") + R"rawliteral(; margin-top: 20px; padding: 15px; background-color: #1a1a2e; border-radius: 8px; border: 1px solid #3b82f6;"><h4 style="color: #3b82f6; margin-top: 0; font-size: 14px;">🎮 Arkanoid Animation Settings</h4><label for="pongBallSpeed">Ball Speed</label><input type="range" name="pongBallSpeed" id="pongBallSpeed"
 ...
 • Active Animations: 60 Hz (with boost enabled, during bounces/explosions)<br>
...
void handleSave() {
 ...
 // Save Mario Idle Encounters (v1.5.2)
 settings.marioIdleEncountersEnabled = server.hasArg("marioIdleEncounters");
 if (server.hasArg("marioEncounterFrequency")) {
 settings.marioEncounterFrequency = server.arg("marioEncounterFrequency").toInt();
 }
 if (server.hasArg("marioEncounterSpeed")) {
 settings.marioEncounterSpeed = server.arg("marioEncounterSpeed").toInt();
 }
...
<!DOCTYPE html><html><head><title>Factory Reset</title><style> body{font-family:Arial;background:#1a1a2e;color:#e94560;display:flex;justify-content:center;align-items:center;height:100vh;margin:0}.msg{text-align:center}</style></head><body><div class="msg"><h1>&#128260;</h1><p>Factory Reset Complete!<br>All settings erased. Device restarting in AP mode.<br>Connect to "PCMonitor-Setup" to reconfigure.</p></div></body></html>
    ...
    Serial.println("FACTORY RESET: All settings cleared");
    ESP.restart();
  } else {
    // Show confirmation page (2-step)
    String html = R"rawliteral(
<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Factory Reset</title><style> body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;margin:0;padding:20px;background:linear-gradient(135deg,#0f0c29 0%,#1a1a2e 50%,#24243e 100%);color:#e0e7ff;display:flex;justify-content:center;align-items:center;min-height:100vh}.container{max-width:400px;text-align:center;background:rgba(22,33,62,.8);padding:30px;border-radius:12px;border:1px solid rgba(255,107,107,.3);box-shadow:0 4px 20px rgba(255,107,107,.2)}h1{color:#ff6b6b;font-size:48px;margin:0}.h2{color:#ff6b6b;font-size:20px;margin:10px 0 20px}.warning{color:#fbbf24;font-size:14px;margin-bottom:20px;padding:15px;background:rgba(251,191,36,.1);border-radius:8px;border-left:3px solid #fbbf24;text-align:left}.btn{display:inline-block;padding:14px 30px;margin:10px 5px;border:none;border-radius:8px;font-size:16px;font-weight:600;cursor:pointer;text-decoration:none;text-transform:uppercase;letter-spacing:.5px}.reset{background:linear-gradient(135deg,#ff6b6b 0%,#ee5a52 100%);color:#fff;box-shadow:0 4px 15px rgba(255,107,107,.3)}.cancel{background:rgba(148,163,184,.2);color:#94a3b8}</style></head><body><div class="container"><h1>&#9888;&#65039;</h1><div class="h2">Factory Reset</div><div class="warning"><strong>&#9888;&#65039; Warning:</strong> This will erase ALL settings including:<br>
&#8226; WiFi credentials<br>
&#8226; Display settings<br>
&#8226; Metric configurations<br>
&#8226; Clock animations settings<br>
&#8226; Network configurations<br><br>
<strong>Make sure you have a backup of your config before proceeding!</strong></div><a href="/reset?confirm=1" class="reset" onclick="return confirm('Are you absolutely sure? This cannot be undone!');">&#128260; Factory Reset</a><br><a href="/" class="cancel">Cancel</a></div></body></html>
)rawliteral";
    server.send(200, "text/html", html);
  }
}
